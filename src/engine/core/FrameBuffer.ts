...
class Framebuffer {
    ...
    public update() {
        ...
        gl.bindTexture(gl.TEXTURE_2D, this.program);
        ...
        gl.bindRenderbuffer(gl.RENDERBUFFER, this.fbo);
    ...
    public unbind() {
        gl.bindFramebuffer(gl.FRAMEBUFFER, this.fbo);
       // gl.bindFramebuffer(gl.FRAMEBUFFER, this.rbo);
    }
    ...
    public configTest() {
        //Objective: create a VAO to render the frame with effects
